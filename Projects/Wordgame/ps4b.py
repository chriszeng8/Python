...
def playGame(wordList):
    ...
    while True:
        ...
        if user_input=='e':
            break
        elif (user_input=='n')|(user_input=='r'):
            ...
            while not ((UC_input=='c')|(UC_input=='u')):
...
#print compChooseWord({'a': 1, 'p': 2, 's': 1, 'e': 1, 'l': 1}, wordList[1:10000], 6)
#compPlayHand({'a': 1, 'p': 2, 's': 1, 'e': 1, 'l': 1}, wordList[1:10000], 6)
